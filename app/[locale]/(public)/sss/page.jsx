...
const ICERIK = {
  tr: {
    ...
    sss: [
      ...
      { s: 'İnegöl’den Almanya’ya mobilya nasıl gönderilir?', c: 'İnegöl’den Almanya’ya (ve diğer Avrupa ülkelerine) mobilyanız güvenli paketlenir, profesyonel taşımayla kapınıza teslim edilir ve talebe göre kurulumu yapılır. Süreç WhatsApp üzerinden ilerler: ürün ve teslimat adresinizi paylaşırsınız, size özel fiyat ve teslim süresi bildirilir.' },
      { s: 'Odaya özel ölçü köşe koltuk yaptırabilir miyim?', c: 'Evet. Köşe koltuğunuzu odanıza tam oturan ölçülerde, size özel ürettiriyoruz. Ölçülerinizi WhatsApp’tan paylaşmanız yeterli; uygun model ve fiyatı birlikte netleştiririz.' },
      { s: 'Möbel İnegöl’ün adresi ve çalışma saatleri nedir?', c: 'Adres: Wobilimo AVM, 2. Kat No.122, İnegöl / Bursa. Mağaza Pazartesi–Cumartesi 09:00–19:30, Pazar 10:00–18:00 açıktır. WhatsApp hattı (+90 536 040 01 08) 7/24 mesaja açıktır.' },
  ...
  en: {
    ...
    sss: [
      ...
      { s: 'How is furniture shipped from İnegöl to Germany?', c: 'Your furniture is carefully packaged, transported professionally and delivered to your door in Germany (and other European countries), with assembly on request. The process runs on WhatsApp: share your product and delivery address, and we send you a tailored price and delivery time.' },
      { s: 'Can I order a custom-size corner sofa?', c: 'Yes. We build your corner sofa in the exact dimensions that fit your room. Just share your measurements on WhatsApp and we’ll finalize the model and price together.' },
      { s: 'What is Möbel İnegöl’s address and opening hours?', c: 'Address: Wobilimo AVM, 2nd Floor No.122, İnegöl / Bursa, Türkiye. Store hours: Mon–Sat 09:00–19:30, Sun 10:00–18:00. WhatsApp (+90 536 040 01 08) is open 24/7.' },
  ...
  de: {
    ...
    sss: [
      ...
      { s: 'Wie werden Möbel von İnegöl nach Deutschland geliefert?', c: 'Ihre Möbel werden sorgfältig verpackt, professionell transportiert und in Deutschland (und anderen europäischen Ländern) bis vor die Haustür geliefert, auf Wunsch mit Montage. Der Ablauf erfolgt über WhatsApp: Teilen Sie Produkt und Lieferadresse mit, und wir senden Ihnen einen individuellen Preis und Liefertermin.' },
      { s: 'Kann ich ein Ecksofa nach Maß bestellen?', c: 'Ja. Wir fertigen Ihr Ecksofa in den exakten Maßen, die zu Ihrem Raum passen. Teilen Sie uns einfach Ihre Maße per WhatsApp mit und wir klären Modell und Preis gemeinsam.' },
      { s: 'Wie lauten Adresse und Öffnungszeiten von Möbel İnegöl?', c: 'Adresse: Wobilimo AVM, 2. Etage Nr.122, İnegöl / Bursa, Türkei. Öffnungszeiten: Mo–Sa 09:00–19:30, So 10:00–18:00. WhatsApp (+90 536 040 01 08) ist rund um die Uhr erreichbar.' },
