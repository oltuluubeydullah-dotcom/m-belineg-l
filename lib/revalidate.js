...
/** İçerik sayfası (hakkımızda, kvkk, gizlilik…) güncelleme sonrası yollar */
export function icerikSayfaRevalidatePaths(slug) {
  if (!slug) return ['/', '/en', '/de'];
  return [`/${slug}`, `/en/${slug}`, `/de/${slug}`];
}
